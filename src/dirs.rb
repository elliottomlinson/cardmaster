...
# stated import
STATED_GIT_DIR = GIT_DIR+"/assets/stated"
STATED_SAVED_DIR = SAVED_OBJ_DIR+"/stated"
STATED_URL = "https://raw.githubusercontent.com/elliottomlinson/rpcg/master/assets/stated/%{set}/%{name}"
